    ...
    <div className="min-h-screen bg-gradient-to-br from-secondary-50 to-primary-50 py-12">
      <div className="container mx-auto px-4">
        <div className="max-w-6xl mx-auto">
          {/* Syncing banner — shown while merging localStorage into DB on login */}
          {syncing && (
            <div className="mb-6 flex items-center gap-3 bg-primary-50 border border-primary-200 text-primary-700 px-5 py-4 rounded-xl">
              <svg
              ...
              <span className="font-medium">
                Synchronisation de votre panier en cours...
              </span>
            </div>
          )}
