...
class CartController {
  ...
  getCart = asyncHandler(async (req, res) => {
    ...
    // Atomic get-or-create: avoids the race condition where two concurrent
    // requests both see "no cart" and both try to create one.
  ...
  clearCart = asyncHandler(async (req, res) => {
    ...
    res.status(200).json(new ApiResponse(200, updatedCart, "Panier vidé"));
  });
}
